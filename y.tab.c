...
{
       0,    68,    68,    72,    75,    76,    77,    82,    81,   119,
     120,   124,   125,   128,   140,   142,   151,   162,   162,   162,
     162,   162,   165,   184,   188,   211,   214,   221,   222,   226,
     230,   231,   235,   236,   240,   241,   242,   246,   247,   248,
     249,   250,   254,   255,   263,   270,   271,   279,   280,   284,
     300,   301,   323,   324,   325,   333,   337,   341,   342,   346,
     348,   353,   357,   358,   359,   360,   361,   362,   368,   362,
     379,   380,   382,   386,   387,   391,   392,   393
};
#endif
...
#line 128 "simple.y"
	...
	if (nargs < MAX_ARGS){
		args_table[nargs] = strdup((yyvsp[0].string_val));
		nargs++;
		//add to reg stack
